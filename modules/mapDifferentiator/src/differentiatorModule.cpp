...
#include "iCub/differentiatorModule.h"

bool differentiatorModule::configure(ResourceFinder &rf) {
    ...
    pThread = new differentiatorThread(moduleName);
...
bool differentiatorModule::interruptModule() {
    handlerPort.interrupt();
    return true;
}

bool differentiatorModule::close() {
...
bool differentiatorModule::respond(const Bottle& command, Bottle& reply)
{
...
bool differentiatorModule::updateModule()
{
    return true;
}

double differentiatorModule::getPeriod()
{
